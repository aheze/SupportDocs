...
public struct SupportDocsView: View {
    ...
    /**
     ...
     - parameter dataSource: URL of the JSON file, where SupportDocs gets its data. This is generated by the GitHub Action.
     ...
     */
    public init(dataSource: URL, options: SupportOptions = SupportOptions(), isPresented: Binding<Bool>? = nil) {
